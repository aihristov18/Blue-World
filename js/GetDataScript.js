...
function InitialiseMap(width, height, placeElement) {
    ...
    for (var y = 0; y < height; y++) // Iterate trough every
    {
        for (var x = 0; x < width; x++) {
            if (y % 2 == 0) {
                codeString += "<polygon id='x" + x + "y" + y + "' points='" + (x * 100) + " " + (y * 85) + ", " + ((x * 100) + 50) + " " + ((y * 85) + 85) + ", " + ((x * 100) - 50) + " " + ((y * 85) + 85) + "' />";
                codeString += "<polygon id='x!" + x + "y!" + y + "' points='" + ((x * 100) + 50) + " " + ((y * 85) + 85) + ", " + ((x * 100) + 100) + " " + ((y * 85)) + ", " + (x * 100) + " " + (y * 85) + "' />"
            }
            else {
                codeString += "<polygon id='x" + x + "y" + y + "' points='" + (x * 100) + " " + ((y / 2 + 0.5) * 170) + ", " + ((x * 100) + 50) + " " + ((y * 85)) + ", " + ((x * 100) - 50) + " " + ((y * 85)) + "' />";
                codeString += "<polygon id='x!" + x + "y!" + y + "' points='" + ((x * 100) + 50) + " " + ((y * 85)) + ", " + ((x * 100) + 100) + " " + ((y / 2 + 0.5) * 170) + ", " + (x * 100) + " " + ((y / 2 + 0.5) * 170) + "' />";
            }
        }
    }
    codeString += "</svg></div>";
